...
export default class Enemy extends Phaser.GameObjects.Sprite {
  ...
  private init_body = (): void => {
    ...
    this.body.setOffset(16 / 2 + 5, 16 / 2)
  ...
  public shoot = (bullets: Phaser.GameObjects.Group) => {
    if (this.scene.time.now > this.last_shot) {
      const bullet1 = new Bullet3(this.scene, this.x - 1, this.y, 1);
      const bullet2 = new Bullet3(this.scene, this.x - 1, this.y, 1);
      const bullet3 = new Bullet3(this.scene, this.x - 1, this.y, 1);
      bullet1.pattern_split(100, -200);
      bullet2.pattern_straight(100);
      bullet3.pattern_split(100, 200);
      bullets.add(bullet1);
      bullets.add(bullet2);
      bullets.add(bullet3);
